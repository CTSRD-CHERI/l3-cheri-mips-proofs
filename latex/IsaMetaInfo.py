...
definitions = \
  [DefinitionInfo("Bit"),
   ...
   DefinitionInfo("PermitCCall", "PermitCCall_alt", inline=True),
   ...
   DefinitionInfo("TranslateAddresses", "TranslateAddresses_alt"),
   ...
   DefinitionInfo("ActionAuthority"),
   DefinitionInfo("CapDerivations"),
   DefinitionInfo("CapDerivationSources"),
   DefinitionInfo("CapDerivationRegisters"),
   DefinitionInfo("WrittenAddresses"),
   ...
   DefinitionInfo("AddressTranslationProp", "AddressTranslationProp_alt"),
