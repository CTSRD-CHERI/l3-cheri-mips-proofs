...
lemma MemoryInvariant_WriteData_getMemByte:
  assumes "slice 3 addr = addr' \<Longrightarrow> extract_byte (unat (addr XOR mask 3) mod 8) msk = 0"
  shows "IsInvariant (read_state (getMemByte addr) =\<^sub>b return val)
...
lemma MemoryInvariant_WriteCap_aux2:
  ...
  shows "getMemByte addr (setMEM (v, addr') s) = getMemByte addr s" 
using assms
unfolding getMemByte_def Let_def
by auto
...
lemma MemoryInvariant_LoadMemoryCap [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (LoadMemoryCap v)"
by MemoryInvariant auto?

lemma MemoryInvariant_LoadMemory [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (LoadMemory v)"
by MemoryInvariant auto?

lemma MemoryInvariant_LoadCap [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (LoadCap v)"
by MemoryInvariant auto?
...
lemma MemoryInvariant_dfn'CGetCause [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CGetCause v)"
unfolding dfn'CGetCause_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CSetCause [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CSetCause v)"
...
lemma MemoryInvariant_ClearRegs [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (ClearRegs v)"
unfolding ClearRegs_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'ClearLo [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'ClearLo v)"
unfolding dfn'ClearLo_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'ClearHi [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'ClearHi v)"
...
lemma MemoryInvariant_dfn'CSub [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CSub v)"
unfolding dfn'CSub_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CCheckPerm [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CCheckPerm v)"
unfolding dfn'CCheckPerm_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CCheckType [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CCheckType v)"
...
lemma MemoryInvariant_dfn'CToPtr [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CToPtr v)"
unfolding dfn'CToPtr_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_CPtrCmp [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (CPtrCmp v)"
unfolding CPtrCmp_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CEQ [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CEQ v)"
unfolding dfn'CEQ_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CNE [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CNE v)"
unfolding dfn'CNE_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CLT [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CLT v)"
unfolding dfn'CLT_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CLE [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CLE v)"
unfolding dfn'CLE_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CLTU [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CLTU v)"
unfolding dfn'CLTU_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CLEU [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CLEU v)"
unfolding dfn'CLEU_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CEXEQ [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CEXEQ v)"
unfolding dfn'CEXEQ_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CNEXEQ [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CNEXEQ v)"
unfolding dfn'CNEXEQ_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CBTU [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CBTU v)"
unfolding dfn'CBTU_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CBTS [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CBTS v)"
unfolding dfn'CBTS_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CBEZ [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CBEZ v)"
unfolding dfn'CBEZ_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'CBNZ [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CBNZ v)"
...
lemma MemoryInvariant_dfn'CTestSubset [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CTestSubset v)"
...
lemma MemoryInvariant_dfn'CCall [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) (dfn'CCall v)"
...
lemma MemoryInvariant_dfn'CReturn [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) dfn'CReturn"
unfolding dfn'CReturn_alt_def 
by MemoryInvariant auto?

lemma MemoryInvariant_dfn'UnknownCapInstruction [MemoryInvariantI]:
  shows "IsInvariant (read_state (getMemByte a) =\<^sub>b return val) dfn'UnknownCapInstruction"
